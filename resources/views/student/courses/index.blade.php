  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3 mb-4">
    <div>
      <div class="d-flex align-items-center gap-2 mb-1">
        ...
        <h4 class="fw-bold mb-0" style="color:var(--brand-primary)">My Courses</h4>
      </div>

      <div class="text-muted small">
        Daftar course yang kamu ikuti. Pilih course untuk lihat module, topic, video, dan tugas.
      </div>

      <div class="d-flex flex-wrap gap-2 mt-2">
        <span class="badge rounded-pill text-bg-light">
          <i class="bi bi-journal-bookmark me-1"></i> {{ $summary->enrolled_count ?? 0 }} course
        </span>
    ...
    <div class="w-100 w-md-auto" style="min-width: 280px;">
      <div class="input-group">
        ...
        <input type="text" id="courseSearch" class="form-control" placeholder="Cari course...">
      </div>
      <div class="small text-muted mt-1 d-none" id="courseSearchHint">Tidak ada course yang cocok.</div>
    </div>
  </div>
        ...
        <div class="card h-100">
          <div class="card-body p-4 d-flex flex-column">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <a href="{{ route('student.courses.show', $course) }}" class="btn btn-brand btn-sm">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body p-5 text-center">
            ...
            <div class="fw-semibold mb-1">Belum ada course</div>

            <div class="text-muted small mb-3">
              Course akan muncul setelah admin assign kamu ke course.
            </div>
